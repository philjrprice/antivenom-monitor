...
for i, (name, ap, bp) in enumerate(priors_list):
    ...
    with cols[i]:
        ...
        if "Neutral" in name:
           st.write(f"Bayes Factor (BF₁₀): **{evidence_shift:.2f}x**", help="The ratio of the likelihood of the alternative hypothesis (Target Efficacy) to the null hypothesis. A value >1 indicates the data supports the treatment effect.")
